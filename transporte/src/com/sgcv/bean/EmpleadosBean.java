...
public class EmpleadosBean {
    ...
    public String urlActualiza="http://192.168.56.1:7001/SGCVServicios/resources/gestorTrabajadorWS/actualizarEmpleado";
...
//        RespuestaEstadosDTO estados = gson.fromJson(respuesta, RespuestaEstadosDTO.class);
    ...
    public RespuestaEmpleadoDTO actualizaEmpleado(EmpleadoDTO empleado){
        Gson gson=new Gson();
        ClienteREST cliente=new ClienteREST();
        String request=gson.toJson(empleado);
        System.out.println(""+request);
        String response=cliente.getResponseDTO(urlActualiza, metodo, request);
        RespuestaEmpleadoDTO empleados=gson.fromJson(response, RespuestaEmpleadoDTO.class);
//        System.out.println(respuesta);
//        RespuestaEstadosDTO estados = gson.fromJson(respuesta, RespuestaEstadosDTO.class);
        return empleados;
