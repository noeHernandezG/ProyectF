 ...
 * @author FERRUZ
 */
public class trabajadores_nuevos extends javax.swing.JFrame {

    /**
     * Creates new form vista_trabajador
     */
    public trabajadores_nuevos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(trabajadores_nuevos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new trabajadores_nuevos().setVisible(true);
            }
        });
    }
