...
public class trabajadores_modificar_datosP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ELEGIR:", "HOMBRE", "MUJER" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(trabajadores_modificar_datosP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
